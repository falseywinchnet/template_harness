...
- [ ] P006 | Select methods, representations, and compute budgets | stage=design | mode=refine | tags=methods,design,performance | depends=P003,P005 | accept=Each method records assumptions, failure tests, verification boundary, arithmetic model, scale, time and memory budget, and a pivot condition
...
- [ ] P016 | Build the reproducibility package | stage=reproduction | mode=refine | tags=reproduction,release,compute | depends=P013 | accept=A clean environment can run the truthful quick audit and regenerate every theorem-bearing or result-bearing artifact with recorded resources
