...
- [ ] P012 | Formalize or certify the high-risk seam where justified | stage=verification | mode=either | tags=formal,certificate,performance | depends=P010 | accept=Chosen seam matches the target statement, exposes its trusted base, replays in a pinned environment, and stays inside its recorded build budget
...
- [ ] P019 | Package manuscript, metadata, checksums, and release manifest | stage=publication | mode=refine | tags=publication,package,pdf | depends=P018 | accept=Release package is minimal, deterministic, identified, independently checked, and passes log plus page-by-page PDF inspection
